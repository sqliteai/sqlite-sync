...
| `watermark_db_version` | Stable upper watermark captured for this chunk stream. Store this after all chunks are durably transferred/applied. With `max_window_bytes`, the final chunk reports the *reduced* watermark the capped window reached. |
